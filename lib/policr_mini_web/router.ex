defmodule PolicrMiniWeb.Router do
  ...
  scope "/admin/api", PolicrMiniWeb.Admin.API do
    ...
    get "/chats/:id/anti_spam_config", AntiSpamConfigController, :show
    put "/chats/:id/anti_spam_config", AntiSpamConfigController, :update

    get "/chats/:id/welcome_message", WelcomeMessageController, :show
    put "/chats/:id/welcome_message", WelcomeMessageController, :update
    post "/chats/:id/welcome_message/preview", WelcomeMessageController, :preview
